 ...
 * background, is activated from the background or is getting destroyed. Call
 * {@link #pause()} from within the Activity.onPause() method and
 * {@link #resume()} from the Activity.onResume() method. Call
 * {@link #destroy()} from within the Activity.onDestroy() method.</li>
 * </ol>
...
public class IQUSDK {
     ...
     */
    private Object m_propertySemaphore;
    ...
    /**
     * This method stops the update thread and destroys the current IQU
     * instance.
     * <p>
     ...
     * </p>
     * <p>
     * This method must be called from the Activity's onDestroy method. If this
     * does not happen the IQU instance might stay active including the update
     * thread.
     * </p>
     */
    public void destroy() {
